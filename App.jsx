    ...
    <div className="page" dir="rtl">
          ...
          <nav className="nav">
            <div className="logo">
              ...
              <div className="logo-text">
                <span>Afq Systems &amp; IT</span>
                <span>Mohamed Al-Zallawi</span>
              </div>
            </div>
          ...
          <div className="container hero-grid">
            <div>
              ...
              <h1 className="hero-title">
                محمد (حمدي) الزلاوي
                <br />
                <span>مطور أنظمة | Afq Systems &amp; IT</span>
              </h1>
              ...
              <div className="hero-tags">
                ...
                <div className="tag">IT Solutions</div>
              </div>
            ...
            <aside className="hero-card">
              <div className="hero-card-header">
                <div className="hero-card-title">ملخص سريع</div>
                <div className="hero-card-subtitle">Snapshot · Mohamed Al-Zallawi</div>
              </div>
              ...
              <div className="hero-card-item">
                <span>مجال التركيز</span>
                <span>
                  أنظمة إدارة صالات الألعاب، المتاجر الإلكترونية، حلول الترخيص والأتمتة.
                </span>
              </div>
              <div className="hero-card-item">
                <span>الموقع</span>
                <span>ليبيا – متاح للعمل عن بُعد وداخل البلاد.</span>
              </div>
            </aside>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="about-text">
              <p>
                ...
                <strong>Afq Systems &amp; IT</strong>. أعمل على تطوير حلول تقنية عملية
          ...
          <div className="container">
            ...
            <article className="project-card">
              <div className="project-header">
                <div className="project-title">Afq Game Hall System</div>
            ...
            <article className="project-card">
              <div className="project-header">
                <div className="project-title">Afq Store</div>
            ...
            <article className="project-card">
              <div className="project-header">
                <div className="project-title">Afq Licensing System</div>
      ...
      <footer className="footer">
        <div className="container footer-row">
          <div>
            © {year} Mohamed (Hamdi) Al-Zallawi · Afq Systems &amp; IT
          </div>
